 ...
 * 
 * Responsible for initialising and configuring the 
 * PetriGraph component and adding handlers.
 * 
 * Responsible for generating and initialising a 
 * reachability graph and installing handlers, then managing
 * the synchronisation between the Petri net and reachability 
 * graph components.
 * 
 * Also acts as an interface for actions from the editor components.
 * 
